<script context="module" lang="ts">
	export interface TournamentFlowInteface {
		...
		setTopBracket: (bracketSize: 'all' |128|32|8| number) => void;
...
<script lang="ts">
	...
	} from '$lib/components/flow_all_terrain/stores';
	import { focusNodeAnimation } from '$lib/components/flow_all_terrain/stores';
